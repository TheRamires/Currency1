...
public class FragmentChart extends Fragment implements OnChartValueSelectedListener, OnChartGestureListener {
    ...
    public void onValueSelected(Entry e, Highlight h) {
        Log.d(LOG,"onValueSelected y="+e.getY()+"; x="+e.getX());
        eSelected=e;

    }
    @Override
    public void onChartGestureEnd(MotionEvent me, ChartTouchListener.ChartGesture lastPerformedGesture) {
        Log.d(LOG, "onChartGestureEnd "+lastPerformedGesture.name());

        if (lastPerformedGesture.name().equals("SINGLE_TAP")) {
            Log.d(LOG, "onChartGestureEnd x=" + eSelected.getX() + " Y " + eSelected.getY());
    ...
    public void onChartGestureStart(MotionEvent me, ChartTouchListener.ChartGesture lastPerformedGesture) {
        Log.d(LOG,"onChartGestureStart" );

    }
    @Override
    public void onChartSingleTapped(MotionEvent me) {
        Log.d(LOG,"onChartSingleTapped y="+me.getY()+"; x="+me.getX());
    ...
    public void onChartFling(MotionEvent me1, MotionEvent me2, float velocityX, float velocityY) {
        Log.d(LOG," onChartFling" );

    }

    @Override
    public void onChartScale(MotionEvent me, float scaleX, float scaleY) {
        Log.d(LOG,"onChartScale " );

    }

    @Override
    public void onChartTranslate(MotionEvent me, float dX, float dY) {
        Log.d(LOG," onChartTranslate" );
